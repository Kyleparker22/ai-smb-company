  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  function renderReport(el) {
    ...
    el.innerHTML = '<div class="sheet"><div class="rtop"><div class="logo">' + esc(D.client) + '</div><h1>' + esc(D.employee || "Your digital employee") +
      ...
      (r.buckets && r.buckets.length ? '<div class="rh">The three numbers a business actually measures</div><div class="stats">' +
        r.buckets.map(function (b) { return '<div class="stat"><div class="v' + (b.accent ? " ac" : "") + '">' + esc(b.v) + '</div><div class="l">' + esc(b.l) + '</div></div>'; }).join("") + '</div>' : '') +
