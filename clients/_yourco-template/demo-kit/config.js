...
window.DEMO = {
  ...
  report: {
    ...
    // The three buckets every business measures AI in (audit-sop rule, 2026-07-14):
    // the audit's promise and this monthly report speak the same language end-to-end.
    buckets: [
      { v: "$418K", l: "revenue uplift — deposits requested on time, jobs greenlit faster" },
      { v: "~31 hrs", l: "cost savings — coordination hours back in the month", accent: true },
      { v: "0", l: "risk mitigation — unapproved sends, missed proposals, or wrong dollar figures" },
    ],
    did: [
