#!/usr/bin/env python3
"""Proof OS — server. Stdlib only, 127.0.0.1:8859."""
import sys
...
ROUTES = {
    ...
    ("POST", "/api/jobs/<id>/release"): lambda q, b: agents.release_job(q["id"]),
    ("GET", "/api/waiting"): lambda q, b: core.waiting_on_proof(),
    ("GET", "/api/promise/<hours>"): lambda q, b: core.promise_date(float(q["hours"])),
...
if __name__ == "__main__":
    serve.run(ROOT / "app", ROUTES, PORT, "Proof OS")
